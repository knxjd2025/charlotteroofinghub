...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Your trusted source for finding quality roofing companies in Charlotte, NC. Browse 25+ verified roofers and get instant roof estimates.",
...
function OrganizationSchema() {
  ...
  const schema = {
    ...
    name: "Charlotte Roofing Hub",
    url: "https://charlotteroofinghub.com",
    // logo URL points at the auto-generated apple-icon route (180x180 PNG)
    // until a higher-resolution brand logo is uploaded. Schema.org Organization
    // recommends a square logo of at least 112x112 px.
...
// SpeakableSchema (Voice Assistants): the global SpeakableSpecification used
// to point at "h1, .hero-description, .faq-answer" but the page-level lead
// paragraphs already carry data-speakable="true" attributes individually,
// which is the more current AEO pattern. The mainEntity ItemList here was
// also a stub (numberOfItems: 25, single placeholder item) duplicating what
// /companies emits properly. Removed to keep the global schema graph lean
// and let the page-level signals do the work.
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Favicons & touch icons are auto-generated by Next.js metadata file
            conventions: src/app/icon.tsx (32×32) and src/app/apple-icon.tsx
            (180×180). The static favicon.ico in src/app/ is the fallback for
            legacy clients. theme-color is set via the viewport export above. */}
